...
class Game_Map {
    ...
    /** @return {number} */
    mapId() { return this.mapId_ }

    /** @return {number} */
    displayX() { return this.displayX_ }

    /** @return {number} */
    displayY() { return this.displayY_ }

    /** @return {String} */
    parallaxName() { return this.parallaxName_ }

    /** @param mapId {number} */
    requestRefresh(mapId) { this._needsRefresh = true }

    /** @return {boolean} */
    isNameDisplayEnabled() { return this.nameDisplay_ }

    disableNameDisplay() { this.nameDisplay_ = false }

    enableNameDisplay() { this.nameDisplay_ = true }
